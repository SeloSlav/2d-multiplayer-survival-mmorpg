...
export namespace Reed {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Reed): void {
    Reed.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Reed {
    return Reed.getTypeScriptAlgebraicType().deserialize(reader);
  }
