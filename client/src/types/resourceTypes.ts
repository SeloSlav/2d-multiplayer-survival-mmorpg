...
import { Corn, Hemp, Mushroom, Pumpkin } from '../generated';

// Union type for all harvestable resources
export type HarvestableResource = Corn | Hemp | Mushroom | Pumpkin;

// Resource type discriminator
export type ResourceType = 'corn' | 'hemp' | 'mushroom' | 'pumpkin';
...
export function isHarvestableResource(entity: any): entity is TypedHarvestableResource {
  return isCorn(entity) || isHemp(entity) || isMushroom(entity) || isPumpkin(entity);
}
