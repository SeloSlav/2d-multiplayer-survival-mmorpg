...
// --- Constants --- 
pub(crate) const RAIN_COLLECTOR_COLLISION_RADIUS: f32 = 20.0; // Slightly larger than storage box
pub(crate) const RAIN_COLLECTOR_COLLISION_Y_OFFSET: f32 = 52.0; // Match other placeables
