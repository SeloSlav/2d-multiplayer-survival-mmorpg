...
pub fn get_initial_item_definitions() -> Vec<ItemDefinition> {
    let initial_items = vec![
        ...
        ItemDefinition {
            ...
            description: "Residue from burnt wood. Useful as fuel or for crafting.".to_string(),
            category: ItemCategory::Material,
        ...
        ItemDefinition {
            ...
            description: "A raw mushroom. Edible, but provides little sustenance.".to_string(),
        ...
        ItemDefinition {
            ...
            description: "Oops, cooked it too long. Barely edible, and makes you thirsty.".to_string(),
            category: ItemCategory::Consumable,
        ...
        ItemDefinition {
            ...
            description: "A large, raw pumpkin. Can be cooked or carved.".to_string(),
            category: ItemCategory::Consumable, 
