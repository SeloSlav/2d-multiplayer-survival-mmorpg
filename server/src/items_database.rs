    ...
    let initial_items = vec![
        ...
        ItemDefinition {
            ...
            crafting_cost: Some(vec![
                ...
                CostIngredient { item_name: "Plant Fiber".to_string(), quantity: 200 },
            ]),
            crafting_output_quantity: Some(1),
        ...
        ItemDefinition {
            ...
            description: "A powerful ranged weapon with high damage but slow reload. More accurate than a bow.".to_string(),
            category: ItemCategory::RangedWeapon,
            ...
            crafting_cost: Some(vec![
                ...
                CostIngredient { item_name: "Stone".to_string(), quantity: 150 },
                CostIngredient { item_name: "Cloth".to_string(), quantity: 25 },
            ]),
            crafting_output_quantity: Some(1),
        ...
        ItemDefinition {
            ...
            category: ItemCategory::Armor,
            icon_asset_name: "tallow_headlamp.png".to_string(),
            is_stackable: false,
            stack_size: 1,
            is_equippable: true,
            equipment_slot_type: Some(EquipmentSlotType::Head),
